...
Let's assume you have Google Analytics setup for your account and you want to display your analytics in your application. Check out the link [here](/stats). Well Google has an [API](https://googleapis.dev/nodejs/analytics-data/latest/v1beta.BetaAnalyticsDataClient.html) you can use. You can call this API from a Next API as follows:
