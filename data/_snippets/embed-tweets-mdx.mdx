...
You just import the pre-built component and then use it in your .mdx file. The Tweet component also supports light and dark themes. Here is an example:
...
However, I could not figure out how to change the Tweet's light/dark themes dynamically, and I still had to deal with layout shift. Hmm... what to do?
