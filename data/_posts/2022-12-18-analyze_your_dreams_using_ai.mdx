...
The most incredible aspect of this experiment is that [GitHub Copilot](https://github.com/features/copilot) helped me write the code, and ChatGPT wrote the disclaimer in the website footer. In other words I used generative AI technology to build a website that uses generative AI technology. Wrap your head around that!
