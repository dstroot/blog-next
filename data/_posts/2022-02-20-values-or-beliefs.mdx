...
Every company has their "core values" and they are nearly always some combination of these ten:
...
If we’re aligned on a set of values, then we can trust each other to make decisions that "fit" our culture and values. They help us hire colleagues who are aligned to our values. Values boost morale. 
...
Not so fast. These values are too generic - they don't specify exactly what we mean, or how we want our or employees to act.  They don't tell us what the company stands for, or believes in. They don't tell employees how to make tradeoffs. Most importantly, they don't tell us how to "walk the tightrope" and balance our decisions.
...
* Instead of **openness** say: "_We say what we think, even if it is uncomfortable._"

These examples are starting to bring to life what living our values looks like. However, we can do even better. We often naturally think of choices in terms of "yes or no". Do I want to go out for dinner tonight? The real choice is "**where** do I want to go for dinner?"  

Whatever I choose it means I have **not** chosen other good options. Decisions are about making tradeoffs.  
...
What can we tell our employees about our values that helps them make decisions (and remove stress)?  The most well-known example is Facebook's motto: 
