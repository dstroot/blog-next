...
>
> <cite>&mdash; Sir Winston Churchill, speech to the House of Lords, October 28, 1943</cite>

I recently read the book "How Buildings Learn" by Stewart Brand (creator of the Whole Earth Catalog). It is a highly recommended and wonderful book, and the whole time I was reading it I was also thinking of it metaphorically like creating software. One of Stewart's premises is that buildings adapt - they are constantly refined and reshaped by their occupants. Maintenance is crucial to a building's lifespan and human value. Maintenance is tailoring a building to its actual use, similar to how software maintenance is crucial to tailoring software to its actual use.

As you read my book notes below imagine we are speaking of _software_ rather than _buildings_. Try substituting the words "software" for "buildings" in your mind. See where the metaphor takes your imagination. 

I found it deeply satisfying to think of software as a prediction of the future, yet a prediction of the future that we know is wrong even as we create it. However, it becomes less wrong as time, experience, and knowledge are added.

I believe that there are more general lessons we can take from this book if we think of it as a book about complex systems, and I believe this book can lead to better systems designs in a host of fields. I've personally applied many of these lessons to software engineering, but I am getting ahead of myself. Here are my book notes - if you create software maybe you may recognize your experience and learnings too.
...
- How Buildings Learn: What Happens After They're Built, by Stewart Brand, Penguin Books, 1995, ISBN: 0140139966
