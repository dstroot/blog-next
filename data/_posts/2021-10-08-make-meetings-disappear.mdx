...
Bloomberg [installed a framed New Yorker cartoon](https://wwd.com/business-news/media/bloomberg-new-yorker-cartoon-kaamran-hafeez-conference-rooms-10270074-10270074/) in every conference room in its New York headquarters that reads: “I know we didn’t accomplish anything, but that’s what meetings are for.” 

Bloomberg employees said there are so many meetings it is impossible to book a conference room in the building. Some concluded that Michael Bloomberg had the cartoons placed in the conference rooms to “discourage pointless meetings.”

I personally own a framed copy. 

### Should we Discourage Meetings?

- **Meetings are band-aids**. Too often, meetings are the only way things get done within a company. Without meetings, people don’t know what to do, how to do it, and are afraid to act. It creates limited forward progress, and yet, they are needed because **some** progress is better than **none**. Many organizations use meetings to gain consensus and push things along because otherwise nothing might happen. It is often a manual solution to a systemic problem. Ideally, organizations would have few meetings because people would know their organization/department mission, collaborate asynchronously, know where to find information and resources, innovate, make mistakes, and organically course-correct within a culture of trust and growth. Sadly, that is rare.
...
- **Meetings can be disrespectful**. Have you ever attended a meeting where the presenter is “holding court”, and holding the audience hostage? Bad form, and disrespectful. You should have to have to earn the right to call a meeting. If you want to get input on an idea, project, proposal, or initiative then do the research, put together a persuasive view, walk the halls and talk to the right people, send out an email to get feedback, and start doing the work.

- **Meetings are often poorly run**. Some people are better than others, but some meetings have no agenda, no facilitation, no clear purpose, or meeting minutes. In addition, there are often too many people invited, for too long of a time, covering too little content, with too little accountability.
...
Time is the most valuable asset you have. It’s a non-renewable resource you can never replenish and time can only be spent once. What money buys is time. Time is what’s really valuable.
...
>
> <cite>&mdash; Albert-László Barabási, physicist</cite>{' '}
