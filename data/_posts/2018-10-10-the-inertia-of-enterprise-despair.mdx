...
>
> <cite>
>   &mdash; John Ousterhout, Stanford University ([My Favorite
>   Sayings](http://web.stanford.edu/~ouster/cgi-bin/sayings.php))
> </cite>
...
It’s interesting how risk managers and internal auditors react to Black Swans. Typically swooping in after the outage, keen to bayonet the wounded, with a mandate to add more controls. Making damn sure to close the barn door after the horse has bolted.
...
![Agile-ish Manifesto](https://danstroot.imgix.net/assets/blog/img/agile_manifesto.jpg)
