...
excerpt: 'When building a new product, we all know we should remain agile and launch
  ...
  nuanced by adding more features over time as previous features prove their value.
  Unfortunately, the same process wreaks havoc when it comes to modernizing an existing system. At first, the reason why is not intuitive. In theory, the same principles should apply.'
...
3. Defining a "better job" than the old software is suprisingly difficult. Things like "it will be easier/cheaper to maintain", or "we we be able to implement change faster" are very hard to measure and unlikely to be true do the item below.

4. No one really knows how the legacy system works. When a process is automated via a system, the highly skilled people disappear becuse their knowledge becomes embodied in the software - and the remaining people become dependent on the system. Processes and other systems become intertwined and integrated. This complexity is exactly why existing systems are hard to change.
