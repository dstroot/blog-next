...
Modernizing systems that are in heavy use is difficult. So when people are asked to design a MVP for a modernization effort, several issues become apparent:
