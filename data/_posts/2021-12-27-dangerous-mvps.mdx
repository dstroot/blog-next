...
All too often MVP's ignore basic architectural requirements in the interest of "low cost" and "speed". If the list below isn't addressed during the MVP development and learning process will have issues in the future. 
