...
There might even be "people" (AI driven non-playable characters - AI "influencers") approaching players to talk about a product in a casual way if eye tracking or breathing rate implies you might be interested. Think product placement and influencers on a meta-scale. Metaverse advertising could blur the line between real and fake content. 
