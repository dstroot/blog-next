...
According to the [Guiness Book of World Records](https://www.guinnessworldrecords.com/world-records/636196-oldest-software-system-in-continuous-use) the oldest software system in use is likely either the [SABRE](https://en.wikipedia.org/wiki/Sabre_(travel_reservation_system)) Airline Reservation System (introduced in 1960), or the IRS Individual Master File (IMF) and Business Master File (BMF) systems introduced in 1962–63. 

SABRE went online in 1960. It had cost $40 million to develop and install (about $400 million in 2022 dollars). The system took over all American Airlines booking functions in 1964, when the name oficially changed to SABRE. The system was expanded to provide access to external travel agents in 1976. Notably, in 2020 Sabre signed a [ten year deal with Google](https://www.sabre.com/insights/releases/sabre-forges-10-year-partnership-with-google-to-build-the-future-of-travel/) to migrate SABRE to Google's cloud infrastructure. 

What is the secret to the long lifespan of these systems? Shouldn't companies with very long-lived products (annuities, life insurance, etc.) study these cases? After all, they need systems that last most of a human lifespan. Shouln't _any company_ want to make their investments in software last? 
