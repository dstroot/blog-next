...
Airlines recognize that the value of addressing problems _before they happen_. Much like the New York MTA's scheduled maintenance system, Airlines have spent years (and millions of dollars) creating a system called "progressive maintenance" that works, very, very well. 
...
An even better story of the power of maintenance shows that even stuctures made of grass can last indefinitely. Inca rope bridges were simple suspension bridges constructed by the Inca Empire. The bridges were an integral part of the Inca road system were constructed using ichu grass. The grass deteriorated rapidly. The bridge's strength and reliability came from the fact that _each cable was replaced every June_ by local villagers as part of their mit'a public service or obligation. 
...
Maintenance is a process. It requires work, and work of a certain type. Whatever its ultimate goal — improved scalability, reliability, or performance — practical know-how, business knowledge, and skilled labor are required. 

Once a system degrades it is an even bigger challenge to fund deferred maintenance (or "technical debt"). No one wants to pay for it. Initiatives to repair and restore operational excellence gradually, much the way one would fix up an old house, tend to have few volunteers among engineering teams. No one gets noticed doing maintenance. No one gets promoted because of maintenance. Instead, these are the jobs that are either eliminated or offshored to less skilled, less knowledgeable, and of course cheaper labor. 
