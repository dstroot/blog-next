...
## Unforunately, Maintenance is Chronically Undervalued
...
Finally, maintenance work is typically an operational cost, yet building a new new system, or large feature, can often be capitalized and depreciated over many years. Thus making the future costs someone else's problem in many cases.
