...
Why can't software last forever? It's not made of wood, concrete, or steel. It doesn't rot, weather, or rust. A working algorithm is a working algorithm. Technology doesn’t need to be beautiful, or to impress other people, to be effective. 
...
Finally, maintenance work is typically an operational cost, yet building a new new system, or a significant new feature, can often be capitalized. Thus making the future costs someone else's problem.
