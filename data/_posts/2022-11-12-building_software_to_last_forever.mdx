...
In a way, it was a small miracle that they lasted so long, an “anomaly,” as one mechanic put it. _Except it wasn’t._
...
The most incredible story of the power of maintenance shows that even stuctures made of grass can last indefinitely. Inca rope bridges are simple suspension bridges constructed by the Inca Empire. The bridges were an integral part of the Inca road system were constructed using ichu grass. The grass deteriorated rapidly. The bridge's strength and reliability came from the fact that _each cable was replaced every June_ by local villagers as part of their mit'a public service or obligation. 
...
Future-proofing means constantly rethinking and iterating on the existing system. We know from both research and experience that iterating and maintaining existing solutions is much more likely, and less expensive way to improve software. 
...
However, due to factors discussed above, software does not always receive the proper amount of maintance to remain healthy. Bad software is unmaintained software. Eventually a larger modernization effort becomes necessary to restore a system to operational and functional excellence.
