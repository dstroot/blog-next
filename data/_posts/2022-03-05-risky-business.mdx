...
* **Technology Supply Chain**: Supply chain risk covers a lot of territory. Recently, during the pandemic companies couldn't procure basic items like laptops and monitors, or even printer toner, due to supply chain issues. Something we hadn't considered before. Companies typically think of things like these, any of which could be a major source of disruption:
