...
During the deal our CEO, CTO and CPO got together and decided that what the customer was asking for was simple and easy to build. They made committments to the customer without involving any teams in the process. To top it off they rubbed their crystal ball, invented a date, and threw it over the fence as well.

Our CTO told me to “Figure it out” and “Make it work.” When questions came up about what the customer wanted those were answered with “I don’t have time for that. Do whatever you think would be best.”

<hr />

How do you feel after reading that? Has that ever happened to you? If it makes you angry consider this - The C-Suite wasn't estimating the time to build the feature, they were **estimating the number they needed to win the business**. Successfully, I might add - job done by the C-suite!

Your job is **not** to build the feature in the X weeks, rather it is to manage the customer while the project is completed in whatever time it takes. The customer probably **didn't want or expect an X week delivery of specific scope**, instead maybe they were just just pushing to see how much your company wanted the business, or maybe they wanted vague requirements that they could change them as the project went along while keeping you (the vendor) under pressure to deliver whatever thing they eventually decided that they wanted.

## 1. Reality is unaffected by estimates. 
...
It’s also generally a prediction we make with too little information. When doing complex work, at the start we know we lack information. Our information and understanding are limited to the extent that getting the estimate right means we got lucky, just like when guessing the number of pennies in the jar.
...
## 7. When you suck at building software, your estimates will suck. When you’re great at building software, your estimates will be mediocre.
...
## 8. The biggest value in estimating isn’t the estimate but checking if there is a common understanding.
...
On top of this, all those elaborate plans are detached from reality and will ultimately slow us down more and more as the project goes on.

Sticking to the plan as it deviates more and more is a dangerous thing. It is better to start with simpler plans that are easy to adjust. When you break down the whole project to the smallest details, at least now you can fool yourself that you have a better idea of how much later the project will be delivered.
