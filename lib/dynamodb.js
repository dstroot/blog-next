...
export const put = (params) => ddbDocClient.send(new PutCommand(params));
export const upd = (params) => ddbDocClient.send(new UpdateCommand(params));
export const scan = (params) => ddbDocClient.send(new ScanCommand(params));
export const query = (params) => ddbDocClient.send(new QueryCommand(params));
