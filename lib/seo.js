...
export const SEO = (props) => {
  const { common, twitter, openGraph } = props;

  return (
    <Head>
      {/* BASIC SEO */}
      <title>{common.title}</title>
      <meta name='description' content={common.description} key='description' />
      <meta name='author' content={common.author} key='author' />

      {/* OPEN GRAPH */}
      <meta property='og:type' content={openGraph.type} key='ogtype' />
      {openGraph.siteName && (
        <meta
      ...
      <meta property='og:title' content={common.title} key='ogtitle' />
      {/*
      ...
      */}
      ...
      <meta property='og:image' content={common.image} key='ogimage' />
      {/*
      ...
      */}
      ...
      <meta name='twitter:site' content={twitter.handle} key='twsite' />
      <meta name='twitter:title' content={common.title} key='twtitle' />
      <meta
        name='twitter.description'
        content={common.description}
        key='twdescription'
      />
      <meta name='twitter:image' content={common.image} key='twimage' />
      {common.publishedDate && (
        <meta
          property='article:published_time'
          content={common.publishedDate}
          key='twdate'
        />
      )}
    </Head>
