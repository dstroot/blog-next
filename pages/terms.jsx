      ...
      <Container>
        ...
        <div className='max-w-2xl mx-auto converted-html'>
          ...
          <p>
            ...
            continue to use {CMS_NAME} if you do not agree to take all of the terms and conditions
            stated on this page.
          </p>
          <p>
          ...
          <h3>Cookies</h3>
          <p>
            We employ the use of cookies. By accessing {CMS_NAME}, you agreed to use cookies in
            agreement with the {CMS_NAME}s Privacy Policy.
          </p>
          <p>
          ...
          <h3>License</h3>
          <p>
            Unless otherwise stated, {CMS_NAME} and/or its licensors own the intellectual property
            rights for all material on {CMS_NAME}. All intellectual property rights are reserved.
            You may access this from {CMS_NAME} for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from {CMS_NAME}</li>
            <li>Sell, rent or sub-license material from {CMS_NAME}</li>
            <li>Reproduce, duplicate or copy material from {CMS_NAME}</li>
            <li>Redistribute content from {CMS_NAME}</li>
          </ul>
          <p>
          ...
          <p>
            ...
            information in certain areas of the website. {CMS_NAME} does not filter, edit, publish
            or review Comments prior to their presence on the website. Comments do not reflect the
            views and opinions of {CMS_NAME},its agents and/or affiliates. Comments reflect the
            views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, {CMS_NAME} shall not be liable for the Comments or for any
            liability, damages or expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            {CMS_NAME} reserves the right to monitor all Comments and to remove any Comments which
          ...
          <ul>
            ...
            <li>The Comments will not be used to solicit or promote business or custom or</li>
            present commercial activities or unlawful activity.
          </ul>
          <p>
            You hereby grant {CMS_NAME} a non-exclusive license to use, reproduce, edit and
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of {CMS_NAME}; and (d) the link is
          ...
          <p>
            ...
            linking to our website, you must inform us by sending an e-mail to {CMS_NAME}. Please
          ...
          <ul>
            ...
            within the context and format of content on the linking partys site.
          </ul>
          <p>
            No use of {CMS_NAME}s logo or other artwork will be allowed for linking absent a
