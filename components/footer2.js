...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 text-gray-600 px-6 lg:px-8 py-8">
      <div classNames="flex flex-row items-center">
      ...
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center mt-8 lg:mt-12 border-t-2 border-gray-200 pt-2">
        <div className="text-sm mt-0 text-center md:text-left">
...
/*
        <div className="">
          <h5 className="text-xl font-semibold text-gray-700">Connect</h5>
          <nav className="mt-4 mr-6 float-right">
